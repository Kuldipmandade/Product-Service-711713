...
public interface ProductService {
	...
	public Product_Supplier_Category product_getproductwithSCbyPId(long productId);
	...
	ResponseEntity<Product_Supplier_Category> getProductByIdwithSC(long productId);
	Product_Supplier_Category getProductWithSCByPId(long productId);
